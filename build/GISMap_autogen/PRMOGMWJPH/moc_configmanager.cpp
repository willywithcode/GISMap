...
QT_MOC_LITERAL(1, 14, 20), // "configurationChanged"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "ConfigManager\0configurationChanged\0"
};
...
void ConfigManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConfigManager::configurationChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ConfigManager::configurationChanged()
{
